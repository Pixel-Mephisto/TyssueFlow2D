...
class TissueMesh:
    ...
    # ==========================================
    # TOPOLOGICAL SURGERY & DYNAMIC RESOLVER
    # ==========================================
    def perform_t1_swap(self, he1_id: int, rest_length: float = 0.08) -> Tuple[bool, Optional[int], Optional[int], Optional[int], Optional[int]]:
        ...
        if pd.isna(he2) or he2 == -1: return False, None, None, None, None
        ...
        if length < 1e-6: return False, None, None, None, None
    ...
    def resolve_t1_transitions(self, threshold: float = 0.05, rest_length: float = 0.08, max_iter: int = 5) -> int:
        """
        Scans the entire mesh and resolves short edges to prevent topological collapse during dynamics.
        """
        total_swaps = 0
